...
class MinorPageState extends State<MinorPage> {
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Tooltip(
                  message: "To suggest maintenance task based on maintenance part",
                  verticalOffset: 20,
...
class MinorPage extends StatefulWidget {
  @override
  MinorPageState createState() => MinorPageState();
}
